...
cardNumberValid = false;
  ...
  ngAfterViewInit(): void {
    this.stripe = Stripe('pk_test_51HdEUlAVsC2k64vtnR7F26Of8nwzI681zQtFlnckhZgiFynOcKnWI3VxIUuFoddBpm4xlMaUfC4S4KLkhnJvYA9Z0040jRJ7mI');
    const elements = this.stripe.elements();
    this.cardNumber = elements.create('cardNumber');
    this.cardNumber.mount(this.cardnumberElement.nativeElement); // mount stripe element to native element from html component
  ...
  private async createOrder(basket) {
